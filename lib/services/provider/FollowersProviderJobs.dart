...
// class FollowersProviderJobs with ChangeNotifier {
...
//         //test
//         // Uri.parse(
//         //     'http://192.168.1.72/HR-API/social_check_jobs/getall_followers.php')
//         Uri.parse(
//             'https://www.cm-mejobs.com/HR-API/social_check_jobs/getall_followers.php'),
//       );
...
//         // Uri.parse(
//         //     'http://192.168.1.72/HR-API/social_check_jobs/add_followers.php'),
//         Uri.parse(
//             'https://www.cm-mejobs.com/HR-API/social_check_jobs/add_followers.php'),
//         headers: {
